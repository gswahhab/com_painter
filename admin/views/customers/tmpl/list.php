		...
		<thead>
			<tr>
				...
				<th width="75" nowrap="nowrap">
					...
					<? echo JHtml::_('grid.order',  $this->items, 'filesave.png', 'customers.saveorder'); ?>
				</th>
				...
				<th>
					<? echo JText::_('COM_PAINTER_LIST_CUSTOMER_DESCRIPTION_LABEL'); ?>
				</th>
				<th width="1%">
					<? echo JText::_('COM_PAINTER_LIST_CUSTOMER_ID_LABEL'); ?>
				</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr class="row<? echo $k; ?>">
				...
				<td>
					...
					if(JTable::isCheckedOut($user->get('id'), $row->checked_out)){
						echo JHTML::_('grid.checkedout', $row, $i, 'customer_id');
						echo JText::_( $row->customer_name);
					}else{
				...
				<td class="order">
					<span><? echo $this->page->orderUpIcon( $i, ($i > 0), 'customers.orderup', 'Move Up'); ?></span>
					<span><? echo $this->page->orderDownIcon( $i, count($this->items), true, 'customers.orderdown', 'Move Down'); ?></span>
