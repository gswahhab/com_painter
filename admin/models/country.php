...
class PainterModelCountry extends JModelAdmin
{
	...
	{
		if($form = $this->loadForm('com_painter.country', 'country', array('control'=>'jform', 'load_data'=>$loadData))){
			return $form;
		}
		JError::raiseError(0, JText::sprintf('JLIB_FORM_INVALID_FORM_OBJECT', 'country'));
		return null;
	}
	/**
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_painter.edit.country.data', array());
		...
		if (empty($data)) {
			...
			try {
				...
				$form		= JForm::getInstance('country', JPATH_COMPONENT.DS."models".DS."forms".DS."country.xml");
