...
{
	public function getTable($name = 'Materials', $prefix = 'Table', $options = array())
	{
	...
	{
		if($form = $this->loadForm('com_painter.material', 'material', array('control'=>'jform', 'load_data'=>$loadData))){
			return $form;
		}
		JError::raiseError(0, JText::sprintf('JLIB_FORM_INVALID_FORM_OBJECT', 'material'));
		return null;
	}
	/**
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_painter.edit.material.data', array());
		...
		if (empty($data)) {
			...
			try {
				...
				$form		= JForm::getInstance('material', JPATH_COMPONENT.DS."models".DS."forms".DS."material.xml");
			...
			if ($this->getState('material.id') == 0) {
