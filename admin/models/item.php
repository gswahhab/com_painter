...
class PainterModelItem extends JModelAdmin
{
	...
	{
		if($form = $this->loadForm('com_painter.item', 'item', array('control'=>'jform', 'load_data'=>$loadData))){
			return $form;
		}
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_painter.edit.item.data', array());
		...
		if (empty($data)) {
			...
			try {
				...
				$form		= JForm::getInstance('item', JPATH_COMPONENT.DS."models".DS."forms".DS."item.xml");
